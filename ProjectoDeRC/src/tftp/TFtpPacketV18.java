...
public class TFtpPacketV18 {
	...
	/**
	 * Constructor for creating a new, initially, empty TftpPacket of a given
	 * OpCode.
	 * 
	 **/
	...
	/**
	 * Get the block number of this TFTP Packet, provided it is a DATA or an ACK
	 * packet
	 * 
	 */
	...
	/**
	 * Get the file name of this TFTP Packet, provided it is an OP_WRQ or a OP_RRQ
	 * packet
	 * 
	 */
	...
	/**
	 * Get the string value of a given option in the TFTP Packet, provided it is an
	 * OACK packet
	 * 
	 */
