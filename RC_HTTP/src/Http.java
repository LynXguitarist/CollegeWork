...
public class Http {
	 ...
	 */
	public static void sendsNotSupportedPage(OutputStream out) throws IOException {
		String page = "<HTML><BODY>Request Not Supported</BODY></HTML>\r\n";
	...
	/**
	 * Parses an HTTP range header sent by a client returning an array the range
	 * values Examples: "range=1000-2000" returns { 1000, 2000 } "range=1000-"
	 * returns { 1000, -1 } If the input is malformed, it returns {-1,-1} or
...
//				+value.substring(pos0+1, pos1)+"\n");
	...
	/**
	 * Parses an HTTP range header sent by a server returning an array with the
	 * range values as well as the size of the file Examples: "range 1000-2000/3000"
	 * returns { 1000, 2000, 3000 } If the input is malformed, it returns {-1,-1,
	 * -1} or something unpredictable
	 */
	...
	/**
	 * From the contents of a form with format application/x-www-form-urlencoded it
	 * returns an object of type Properties associating each element with its value
	 */
